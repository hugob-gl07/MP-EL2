...
public class MainMyLine {
    public static void main(String[] args) {
        ...
        // La longitud de esta línea es 5.0 (triángulo 3-4-5)
        ...
        // 3. SERIALIZA: convierte el objeto MyLine a JSON y lo escribe en "line1.json"
        GsonUtil.guardarObjetoEnArchivo(rutaArchivo,line1);

        // 4. DESERIALIZA: lee el JSON y reconstruye el objeto MyLine
